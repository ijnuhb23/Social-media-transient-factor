...
datatot= pd.read_csv('C://Users//ijnuh//Desktop//JSV//Bayes//Term3//Project_AlternativeData//Python//All_stock_summarised_VADER_scores//All_summarised_VADER_scores.csv')
...
for j in stock_list:
    ...
    if row['12/31/2014'].item() != 'X':
        ...
        for i in range(259,311,1):
            datatot['mean of Stock '+str(stock_name)][i] = np.nan
            datatot['count of Stock '+str(stock_name)][i] = np.nan
...
datatot.to_csv('C://Users//ijnuh//Desktop//JSV//Bayes//Term3//Project_AlternativeData//Python//All_stock_summarised_filter_VADER_scores//All_summarised_filtered_VADER_scores.csv')
